...
<body class="bg-violet-50 min-h-screen">
    ...
    <div class="max-w-md mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <h1 class="text-2xl font-bold text-violet-950">Crear usuario</h1>
        ...
        <div class="bg-white border border-violet-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form action="{{ route('users.store') }}" method="post" class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="password_confirmation" class="text-sm font-medium text-violet-700">Confirmar contraseña</label>
