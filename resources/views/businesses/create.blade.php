    ...
    <div class="max-w-2xl mx-auto px-4 py-10">
        ...
        <div class="flex items-center gap-3 mb-6">
            <h1 class="text-2xl font-bold text-violet-950 dark:text-violet-200">
                Crear <span class="text-violet-600 dark:text-violet-400">negocio</span>
            </h1>
        </div>
            ...
            <div class="p-7">
                <form action="{{ route('businesses.store') }}" method="post" class="flex flex-col gap-5" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="image" class="text-[10px] font-bold uppercase tracking-widest text-violet-400 dark:text-violet-500">
                            Foto del negocio
                        </label>
