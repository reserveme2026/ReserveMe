...
<body class="bg-violet-50 dark:bg-gray-900 min-h-screen transition-colors duration-200">
    ...
    <div class="max-w-2xl mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <div class="flex items-center gap-3 flex-wrap">
            ...
            <span
                class="inline-flex items-center gap-1 bg-violet-50 dark:bg-violet-900 text-violet-700 dark:text-violet-300 text-xs font-semibold px-2.5 py-1 rounded-full border border-violet-200 dark:border-violet-700 shrink-0">
        ...
        <div
            class="bg-white dark:bg-gray-800 border border-violet-100 dark:border-gray-600 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div>
                ...
                <div class="px-6 pt-6 pb-6">
                    <div
                        class="max-w-4xl mx-auto bg-violet-50/70 dark:bg-gray-700/50 border border-violet-100 dark:border-gray-600 rounded-xl px-5 py-5">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                            <div class="flex flex-col gap-0.5">
                                <span
                                    class="text-[10px] font-semibold uppercase tracking-wider text-violet-400 dark:text-violet-500">Direccion</span>
                                <span
                                    class="text-sm font-medium text-violet-950 dark:text-gray-100">{{ $business->address }}</span>
                            </div>

                            <div class="flex flex-col gap-0.5">
                                <span
                                    class="text-[10px] font-semibold uppercase tracking-wider text-violet-400 dark:text-violet-500">Telefono</span>
                                <span
                                    class="text-sm font-medium text-violet-950 dark:text-gray-100">{{ $business->phone }}</span>
                            </div>

                            <div class="flex flex-col gap-0.5 sm:col-span-2">
                                <span
                                    class="text-[10px] font-semibold uppercase tracking-wider text-violet-400 dark:text-violet-500">Email</span>
                                <span
                                    class="text-sm font-medium text-violet-950 dark:text-gray-100">{{ $business->email }}</span>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-violet-100 dark:border-gray-600 mt-5 pt-4">
                            <div class="flex flex-col gap-1">
                                <span
                                    class="text-[10px] font-semibold uppercase tracking-wider text-violet-400 dark:text-violet-500">Descripcion</span>
                                <p class="text-sm text-violet-800 dark:text-gray-300 leading-relaxed">
                ...
                <div class="px-6 pb-6">
                    <div
                        class="max-w-4xl mx-auto border-t border-violet-100 dark:border-gray-700 pt-5 flex flex-wrap items-center gap-2">
