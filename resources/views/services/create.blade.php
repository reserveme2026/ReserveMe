...
<body class="bg-violet-50 dark:bg-gray-900 min-h-screen transition-colors duration-200">
    ...
    <div class="max-w-md mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <h1 class="text-2xl font-bold text-violet-950 dark:text-violet-200">Crear servicio para {{ $business->name }}</h1>
        ...
        <div class="bg-white dark:bg-gray-800 border border-violet-100 dark:border-gray-600 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form action="{{ route('businesses.services.store', $business) }}" method="post" class="flex flex-col gap-5">
                    @csrf
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="description" class="text-sm font-medium text-violet-700 dark:text-violet-400">Descripción</label>
                        <input type="text" name="description" id="description" value="{{ old('description') }}"
                            class="bg-violet-50/70 dark:bg-gray-700 border @error('description') border-red-300 dark:border-red-600 @else border-violet-200 dark:border-gray-600 @enderror
                                   rounded-lg px-3 py-2 text-sm text-violet-950 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-violet-400 dark:focus:bg-gray-600 transition">
                        @error('description')
                            <small class="text-red-500 dark:text-red-400 text-xs">{{ $message }}</small>
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="duration_minutes" class="text-sm font-medium text-violet-700 dark:text-violet-400">Duración (minutos)</label>
                        <input type="number" name="duration_minutes" id="duration_minutes" value="{{ old('duration_minutes') }}"
                            class="bg-violet-50/70 dark:bg-gray-700 border @error('duration_minutes') border-red-300 dark:border-red-600 @else border-violet-200 dark:border-gray-600 @enderror
                                   rounded-lg px-3 py-2 text-sm text-violet-950 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-violet-400 dark:focus:bg-gray-600 transition">
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="price" class="text-sm font-medium text-violet-700 dark:text-violet-400">Precio</label>
                        <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}"
                            class="bg-violet-50/70 dark:bg-gray-700 border @error('price') border-red-300 dark:border-red-600 @else border-violet-200 dark:border-gray-600 @enderror
                                   rounded-lg px-3 py-2 text-sm text-violet-950 dark:text-gray-100
                                   focus:outline-none focus:ring-2 focus:ring-violet-400 dark:focus:bg-gray-600 transition">
                        @error('price')
                            <small class="text-red-500 dark:text-red-400 text-xs">{{ $message }}</small>
