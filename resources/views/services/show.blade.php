...
<body class="bg-violet-50 dark:bg-gray-900 min-h-screen transition-colors duration-200">
    ...
    <div class="max-w-lg mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <h1 class="text-2xl font-bold text-violet-950 dark:text-violet-200">Detalle del servicio</h1>
        ...
        <div class="bg-white dark:bg-gray-800 border border-violet-100 dark:border-gray-600 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6 flex flex-col gap-3">
                ...
                <div class="flex items-center gap-2 text-sm">
                    ...
                    <span class="text-violet-950 dark:text-gray-100 font-medium">{{ $service->name }}</span>
                </div>

                <div class="flex items-center gap-2 text-sm">
                    <span class="font-medium text-violet-400 dark:text-violet-500 w-36">Descripción</span>
                    <span class="text-violet-600 dark:text-violet-400">{{ $service->description }}</span>
                </div>

                <div class="flex items-center gap-2 text-sm">
                    <span class="font-medium text-violet-400 dark:text-violet-500 w-36">Duración</span>
                    <span class="text-violet-800 dark:text-gray-300">{{ $service->duration_minutes }} min</span>
                </div>

                <div class="flex items-center gap-2 text-sm">
                    <span class="font-medium text-violet-400 dark:text-violet-500 w-36">Precio</span>
                    <span class="text-violet-800 dark:text-gray-300">{{ $service->price }} €</span>
                </div>
