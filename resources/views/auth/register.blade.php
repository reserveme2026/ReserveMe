            ...
            <div class="p-6">
                ...
                <form action="{{ route('register') }}" method="post" class="flex flex-col gap-5">
                    ...
                    <div class="flex items-center justify-center gap-2 mt-2">
                        <button type="submit"
                            class="px-4 py-2 text-sm font-semibold bg-purple-500 hover:bg-purple-600 dark:bg-purple-700 dark:hover:bg-purple-600 text-white rounded-lg transition-colors duration-150 shadow-sm cursor-pointer">
                            Registrarse
                        </button>
                        <a href="{{ route('login') }}"
