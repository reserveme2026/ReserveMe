            ...
            <div class="p-6">
                ...
                <form action="{{ route('login') }}" method="post" class="flex flex-col gap-5">
                    ...
                    <div class="flex items-center justify-center gap-2 mt-2">
                        <button type="submit"
                            class="px-4 py-2 text-sm font-semibold bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 text-white rounded-lg transition-colors duration-150 shadow-sm cursor-pointer">
                            Entrar
                        </button>
                        <a href="{{ route('register') }}"
                            class="px-4 py-2 text-sm font-semibold border border-violet-200 dark:border-gray-600 text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-150">
                            Registrarse
                        </a>
                    </div>
