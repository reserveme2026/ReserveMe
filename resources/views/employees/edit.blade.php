...
<body class="bg-violet-50 dark:bg-gray-900 min-h-screen transition-colors duration-200">
    ...
    <div class="max-w-md mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <h1 class="text-2xl font-bold text-violet-950 dark:text-violet-200">Editar empleado</h1>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('businesses.employees.update', [$business, $employee]) }}" method="post" class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="email" class="text-sm font-medium text-violet-700 dark:text-violet-400">Email</label>
