                    ...
                    <table class="w-full text-sm text-left">
                        <thead>
                            <tr class="border-b border-violet-100 dark:border-gray-700">
                                ...
                                <th class="px-4 py-3 text-[10px] font-bold uppercase tracking-widest text-violet-400 dark:text-violet-500">Teléfono</th>
                        ...
                        <tbody class="divide-y divide-violet-50 dark:divide-gray-700">
                            @foreach ($employees as $employee)
                                <tr class="hover:bg-violet-50/50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                    <td class="px-4 py-3 text-sm font-medium text-violet-950 dark:text-gray-100">{{ $employee->name }}</td>
                                    <td class="px-4 py-3 text-sm text-violet-800 dark:text-gray-300">{{ $employee->email }}</td>
                                    <td class="px-4 py-3 text-sm text-violet-800 dark:text-gray-300">{{ $employee->phone }}</td>
                                    <td class="px-4 py-3">
