...
<body class="bg-violet-50 min-h-screen">
    ...
    <div class="max-w-lg mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <h1 class="text-2xl font-bold text-violet-950">Detalle del empleado</h1>
        ...
        <div class="bg-white border border-violet-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6 flex flex-col gap-3">
                ...
                <div class="flex items-center gap-2 text-sm">
                    ...
                    <span class="text-violet-950 font-medium">{{ $employee->name }}</span>
                </div>

                <div class="flex items-center gap-2 text-sm">
                    <span class="font-medium text-violet-400 w-36">Email</span>
                    <span class="text-violet-800">{{ $employee->email }}</span>
                </div>

                <div class="flex items-center gap-2 text-sm">
                    <span class="font-medium text-violet-400 w-36">Teléfono</span>
                    <span class="text-violet-800">{{ $employee->phone }}</span>
                </div>
