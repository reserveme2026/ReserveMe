            ...
            <form action="{{ route('employees.schedules.update', [$employee, $schedule]) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="day_of_week" id="day_of_week"
                        ...
                        <option value="0" @if (old('day_of_week', $schedule->day_of_week) == 0) selected @endif>
                            Domingo
                        </option>

                        <option value="1" @if (old('day_of_week', $schedule->day_of_week) == 1) selected @endif>
                            Lunes
                        </option>

                        <option value="2" @if (old('day_of_week', $schedule->day_of_week) == 2) selected @endif>
                            Martes
                        </option>

                        <option value="3" @if (old('day_of_week', $schedule->day_of_week) == 3) selected @endif>
                            Miércoles
                        </option>

                        <option value="4" @if (old('day_of_week', $schedule->day_of_week) == 4) selected @endif>
                            Jueves
                        </option>

                        <option value="5" @if (old('day_of_week', $schedule->day_of_week) == 5) selected @endif>
                            Viernes
                        </option>

                        <option value="6" @if (old('day_of_week', $schedule->day_of_week) == 6) selected @endif>
                            Sábado
                        </option>
                    </select>
